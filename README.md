# bsp-recomputer-j301x

Board support for the SeeedStudio Recomputer J301x (Orin Nano based)

## Using this extension

`bsp-recomputer-j301x` is an [Avocado](https://avocadolinux.org) extension — a reusable fragment of
